...
function(a) {
    a.extend(a.expr[":"], {
        ...
        a(":uppercase:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc(), a(":smallcaps:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc(), a(".remove-accents, .remove-accents > *:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc(), a(document).ajaxComplete(function() {
            a(":uppercase:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc(), a(":smallcaps:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc(), a(".remove-accents, .remove-accents > *:not(input[type!=submit], textarea, .no-remove-accents)").removeAcc()
        })
    }),
    function() {
        var a = this,
    ...
    function(a) {
        ...
        c.prototype.init = function() {
            ...
            if (this.eventsLastMonth = [], this.eventsThisMonth = [], this.eventsNextMonth = [], this.options.events.length)
                if (this.options.multiDayEvents) {
                    if (this.eventsThisMonth = a(this.options.events).filter(function() {
                        ...
                        var e = c.clone().subtract(1, "months"),
                            f = c.clone().add(1, "months");
            ...
            if (this.options.forceSixRows && 42 !== daysArray.length)
                for (var k = b(daysArray[daysArray.length - 1].date).add(1, "days"); daysArray.length < 42;) this.options.showAdjacentMonths ? (daysArray.push(this.createDayObject(b(k), this.eventsNextMonth)), k.add(1, "days")) : daysArray.push(this.calendarDay({
                    classes: this.options.targets.empty + " " + this.options.classes.nextMonth
                }));
            return daysArray
            ...
            var k = "";
            return e.format("YYYY-MM-DD") == a.format("YYYY-MM-DD") && (k += " " + this.options.classes.today), a.isBefore(e, "day") && (k += " " + this.options.classes.past), d.length && (k += " " + this.options.classes.event), this.month.month() > a.month() ? (k += " " + this.options.classes.adjacentMonth, k += this.month.year() === a.year() ? " " + this.options.classes.lastMonth : " " + this.options.classes.nextMonth) : this.month.month() < a.month() && (k += " " + this.options.classes.adjacentMonth, k += this.month.year() === a.year() ? " " + this.options.classes.nextMonth : " " + this.options.classes.lastMonth), this.options.constraints && (this.options.constraints.startDate && a.isBefore(b(this.options.constraints.startDate)) && (k += " " + this.options.classes.inactive), this.options.constraints.endDate && a.isAfter(b(this.options.constraints.endDate)) && (k += " " + this.options.classes.inactive)), !a.isValid() && a.hasOwnProperty("_d") && void 0 != a._d && (a = b(a._d)), k += " calendar-day-" + a.format("YYYY-MM-DD"), k += " calendar-dow-" + a.weekday(), this.calendarDay({
                day: a.date(),
            ...
            b.on("click", "." + this.options.targets.day, function(b) {
                ...
                c.options.adjacentDaysChangeMonth && (a(b.currentTarget).is("." + c.options.classes.lastMonth) ? c.backActionWithContext(c) : a(b.currentTarget).is("." + c.options.classes.nextMonth) && c.forwardActionWithContext(c))
            ...
            if (d) {
                ...
                0 !== g ? (f = c.className.substring(g + 13, g + 23), e.date = b(f)) : e.date = null, this.options.events && (e.events = a.makeArray(a(this.options.events).filter(this.options.multiDayEvents ? function() {
            ...
            if (!a.element.find("." + a.options.targets.nextButton).hasClass("inactive")) {
                ...
                a.month.add(1, "months"), a.render(), a.options.clickEvents.nextMonth && a.options.clickEvents.nextMonth.apply(a, [b(a.month)]), a.options.clickEvents.onMonthChange && a.options.clickEvents.onMonthChange.apply(a, [b(a.month)]), c && a.options.clickEvents.onYearChange && a.options.clickEvents.onYearChange.apply(a, [b(a.month)])
            }
            ...
            var c = a.data.context;
            c.element.find("." + c.options.targets.nextYearButton).hasClass("inactive") || (c.month.add(1, "years"), c.render(), c.options.clickEvents.nextYear && c.options.clickEvents.nextYear.apply(c, [b(c.month)]), c.options.clickEvents.onMonthChange && c.options.clickEvents.onMonthChange.apply(c, [b(c.month)]), c.options.clickEvents.onYearChange && c.options.clickEvents.onYearChange.apply(c, [b(c.month)]))
        }, c.prototype.previousYearAction = function(a) {
            var c = a.data.context;
            c.element.find("." + c.options.targets.previousYear).hasClass("inactive") || (c.month.subtract(1, "years"), c.render(), c.options.clickEvents.previousYear && c.options.clickEvents.previousYear.apply(c, [b(c.month)]), c.options.clickEvents.onMonthChange && c.options.clickEvents.onMonthChange.apply(c, [b(c.month)]), c.options.clickEvents.onYearChange && c.options.clickEvents.onYearChange.apply(c, [b(c.month)]))
        }, c.prototype.forward = function(a) {
            return this.month.add(1, "months"), this.render(), a && a.withCallbacks && (this.options.clickEvents.onMonthChange && this.options.clickEvents.onMonthChange.apply(this, [b(this.month)]), 0 === this.month.month() && this.options.clickEvents.onYearChange && this.options.clickEvents.onYearChange.apply(this, [b(this.month)])), this
        }, c.prototype.back = function(a) {
            return this.month.subtract(1, "months"), this.render(), a && a.withCallbacks && (this.options.clickEvents.onMonthChange && this.options.clickEvents.onMonthChange.apply(this, [b(this.month)]), 11 === this.month.month() && this.options.clickEvents.onYearChange && this.options.clickEvents.onYearChange.apply(this, [b(this.month)])), this
            ...
            return this.month.add(1, "year"), this.render(), a && a.withCallbacks && this.options.clickEvents.onYearChange && this.options.clickEvents.onYearChange.apply(this, [b(this.month)]), this
        }, c.prototype.previousYear = function(a) {
            return this.month.subtract(1, "year"), this.render(), a && a.withCallbacks && this.options.clickEvents.onYearChange && this.options.clickEvents.onYearChange.apply(this, [b(this.month)]), this
            ...
            var c = this,
                d = 0,
                e = a.length;
            for (d; e > d; d++) a[d][c.options.multiDayEvents.endDate] || a[d][c.options.multiDayEvents.startDate] ? (a[d]._clndrEndDateObject = b(a[d][c.options.multiDayEvents.endDate] || a[d][c.options.multiDayEvents.startDate]), a[d]._clndrStartDateObject = b(a[d][c.options.multiDayEvents.startDate] || a[d][c.options.multiDayEvents.endDate])) : (a[d]._clndrEndDateObject = b(a[d][c.options.multiDayEvents.singleDay]), a[d]._clndrStartDateObject = b(a[d][c.options.multiDayEvents.singleDay]));
            return a
    ...
    function() {
        ...
        ! function(b, c) {
            ...
            return Modernizr.svg && (j = mina.backout), c.productLoading = !1, c.postLoading = !1, c.winWidth = b(c).width(), d = {
                common: {
                    init: function() {
                        var a;
                        return Modernizr.svg || b('img[src*="svg"]').attr("src", function() {
                            return b(this).attr("src").replace(".svg", ".png")
                        }), b(".dropdown-toggle").click(function(a) {
                            return "#" === b(this).attr("href") ? (a.preventDefault(), b(this).siblings(".dropdown-menu").toggleClass("opaque-visible")) : void 0
                        }), b(".dropdown-toggle").mouseout(function() {
                            return b(this).siblings(".dropdown-menu").removeClass("opaque-visible")
                        }), h(), History.Adapter.bind(c, "statechange", function() {
                            var a, b;
                            switch (a = History.getState(), b = a.data.ajaxData.post.post_type) {
                                case "post":
                                    return n(a.data.ajaxData);
                                case "product":
                                    return p(a.data.ajaxData);
                                case "so-product":
                                    return p(a.data.ajaxData)
                            }
                        }), b("li.almanac a").click(function(a) {
                            return a.preventDefault(), b(this).add("#almanac-clndr-wrapper").toggleClass("active")
                        }), moment.locale(b("#almanac-clndr-wrapper").attr("lang")), b("#almanac-clndr-wrapper .calendar").clndr({
                            adjacentDaysChangeMonth: !0,
                            clickEvents: {
                                click: function(a) {
                                    return i("get_almanac_day", {
                                        year: a.date.format("YYYY"),
                            ...
                            doneRendering: function() {
                                return b(this.element).find(".clndr-controls .month").html(this.month.format("MMMM")), b(this.element).find(".clndr-controls span").text("")
                            }
                        }), b(c).on("load resize", function() {
                            return c.winWidth = b(c).width(), b("#almanac-clndr-wrapper").css("right", b(c).width() - b("li.almanac a").offset().left - b("li.almanac a").outerWidth()), h()
                        }), b(c).on("scroll", function() {
                            var a;
                            return a = b(c).scrollTop(), a > 960 ? b("#back-to-top").removeClass("transparent-hidden") : b("#back-to-top").addClass("transparent-hidden")
                        }), Modernizr.svg && (a = [], b(".socat-list .ribbon").each(function(c, d) {
                            var e, f;
                            return a[c] = {}, a[c].ribbon = new Snap(b(d).find("svg")[0]), a[c].pathOuter = a[c].ribbon.select("path.outer"), a[c].pathInner = a[c].ribbon.select("path.inner"), e = Snap.color(a[c].pathOuter.attr("fill")), e.s += .1, e.s > 1 && (e.s = 1), f = Snap.hsl(e.h, e.s, e.l), a[c].pathOuterConfig = {
                                from: a[c].pathOuter.attr("d"),
                                to: b(d).data("path-hover-outer"),
                                fromColor: a[c].pathOuter.attr("fill"),
                                toColor: f
                            }, a[c].pathInnerConfig = {
                                from: a[c].pathInner.attr("d"),
                                to: b(d).data("path-hover-inner")
                            }, b(d).hover(function() {
                                a[c].pathOuter.animate({
                                    path: a[c].pathOuterConfig.to,
                                    fill: a[c].pathOuterConfig.toColor
                                }, 250, j), a[c].pathInner.animate({
                                    path: a[c].pathInnerConfig.to
                                }, 250, j)
                            }, function() {
                                return a[c].pathOuter.animate({
                                    path: a[c].pathOuterConfig.from,
                                    fill: a[c].pathOuterConfig.fromColor
                                }, 250, j), a[c].pathInner.animate({
                                    path: a[c].pathInnerConfig.from
                                }, 250, j)
                            })
                        }), c.soRibbons = a), b(".mob-nav-toggle").click(function(a) {
                            return a.preventDefault(), b(this).toggleClass("active"), b(".mob-main-nav").slideToggle("250")
                        })
                    }
                },
                home: {
                    init: function() {
                        var a, d, e, f, g, h;
                        return b(c).on("load resize", function() {
                            return b(".slideshow").height(winWidth < 768 ? function() {
                                return .65 * b(this).width()
                            } : "100%")
                        }), b(c).on("load", function() {
                            return l(".slideshow", ss_fade, ss_duration)
                        }), Modernizr.svg && (h = new Snap(".slideshow-caption svg"), e = h.select("path.outer"), PSRL.pathOuter = e, a = h.select("path.inner"), f = {
                            from: e.attr("d"),
                            to: b("a.slideshow-caption").data("path-hover-outer")
                        }, d = {
                            from: a.attr("d"),
                            to: b("a.slideshow-caption").data("path-hover-inner")
                        }, g = void 0, b("a.slideshow-caption").hover(function() {
                            e.animate({
                                path: f.to
                            }, 250, j), a.animate({
                                path: d.to
                            }, 250, j), clearTimeout(g), b(".slideshow").backstretch("pause")
                        }, function() {
                            e.animate({
                                path: f.from
                            }, 250, j), a.animate({
                                path: d.from
                            }, 250, j), g = setTimeout(function() {
                                b(".slideshow").backstretch("resume")
                            }, ss_duration)
                        })), b("ol.slideshow-nav li a").hover(function() {
                            clearTimeout(g), b(".slideshow").backstretch("pause")
                        }, function() {
                ...
                page_template_template_the_company: {
                    init: function() {
                        return b(c).on("load resize", function() {
                            return b(".slideshow").height(winWidth < 768 ? function() {
                                return .65 * b(this).width()
                            ...
                            return l(".slideshow")
                        }), b(".tog").each(function(a, c) {
                            return b(c).css("margin-top", "-" + b(c).outerHeight() / 2 + "px")
                        }), m()
                    }
                },
                single_product: {
                    init: function() {
                        return l(".gallery", 500, 3e3, !0), b(".item-navigation a").click(function(a) {
                            return q(a, b(this), "product")
                        })
                    }
                },
                single_so_product: {
                    init: function() {
                        return l(".gallery", 500, 3e3, !0), b(".item-navigation a").click(function(a) {
                            return q(a, b(this), "so-product")
                        })
                    }
                },
                news: {
                    init: function() {
                        return l(".gallery"), b(".post-list a").click(function(a) {
                            return o(a, b(this))
                        })
                    }
                },
                ...
                fire: function(a, b, c) {
                    var e;
                    return e = d, void 0 === b && (b = "init"), "" !== a && e[a] && "function" == typeof e[a][b] ? e[a][b](c) : void 0
                },
                loadEvents: function() {
                    return e.fire("common"), b.each(document.body.className.replace(/-/g, "_").split(/\s+/), function(a, b) {
                        return e.fire(b)
                    })
                }
            }, b(document).ready(e.loadEvents), i = function(a, d, e, g) {
                var h, i, j;
                h = {}, h.action = "fda", h.fn = a;
                for (i in d) j = d[i], h[i] = j; /** return b.ajax({url:""+PSRL.homeUrl+"wp-admin/admin-ajax.php",data:h,dataType:"json",success:function(a){return e===f?f(a,g):History.pushState({ajaxData:a},a.title_tag,a.post_link)},error:function(a){return c.console&&console.log(a)}}) **/
            }, h = function() {
                return b(".post-list ul li a .ribbon").each(function(a, c) {
                    return b(c).css("border-top-width", function() {
                        return "" + b(this).closest("a").outerHeight() / 2 + "px"
                    }).css("border-bottom-width", function() {
                        return "" + b(this).closest("a").outerHeight() / 2 + "px"
                    })
                })
            }, f = function(a, c) {
                return b("#almanac-clndr-wrapper").find(".almanac-content .date").text(c.target.date.format("DD MM YYYY")).siblings("p").text(a)
            }, q = function(a, b, d) {
                var e;
                return a.preventDefault(), c.productLoading ? void 0 : (c.productLoading = !0, e = "prev" === b.attr("rel") ? "next" : "prev", i("get_adjacent_item", {
                    post_slug: b.data("slug"),
                    dir: e,
                    post_type: d
                }, p, {
                    dir: e
                ...
                var d;
                return d = a.post.post_type, b("section#" + d + " article").after(a.section_markup), setTimeout(function() {
                    var e, f, g;
                    f = b("section#" + d).find("article").first(), e = b("section#" + d).find("article").last(), "product" === d && b("#" + d + " .sec-caption h1").text(a.post.post_title), "" !== a.next_post_link ? b('.item-navigation a[rel="prev"]').fadeIn().replaceWith(a.next_post_link) : b('.item-navigation a[rel="prev"]').fadeOut(), "" !== a.prev_post_link ? b('.item-navigation a[rel="next"]').fadeIn().replaceWith(a.prev_post_link) : b('.item-navigation a[rel="next"]').fadeOut(), b(".item-navigation a").click(function(a) {
                        return q(a, b(this), d)
                    }), f.addClass("leaving leaving-" + a.dir), e.removeClass("coming-" + a.dir), setTimeout(function() {
                        b("section#" + d).find("article").first().remove(), b("section#" + d).find("article").last().removeClass("coming"), c.productLoading = !1, l(".gallery", 500, 3e3, !0)
                    }, 400), g = a.random_products, b(".product-list > div").each(function(a, c) {
                        return b(c).addClass("leaving"), setTimeout(function() {
                            return b(c).remove()
                        }, 500)
                    }), b(g).each(function(a, c) {
                        return b(c).addClass("entering").appendTo(".product-list"), setTimeout(function() {
                            return b(c).removeClass("entering")
                        }, 500)
                    })
                }, 50)
            }, o = function(a, d) {
                var e, f, g;
                if (!(c.winWidth < 768 || (a.preventDefault(), d.hasClass("current")))) return postLoading ? void 0 : (c.postLoading = !0, g = b(".post-list li").index(d.closest("li")), f = b(".post-list li").index(b(".post-list li a.current").closest("li")), e = g > f ? "next" : "prev", d.addClass("current").closest("li").siblings("li").find("a").removeClass("current"), i("get_item", {
                    post_id: d.data("post-id"),
                    dir: e
                }, n, {
                    dir: e
                }))
            }, n = function(a) {
                return b("section#news article").after(a.section_markup), setTimeout(function() {
                    var d, e, f;
                    e = b("section#news").find("article").first(), d = b("section#news").find("article").last(), f = d.outerHeight(!0), b("#news .post-list").height() < f && b("section#news").animate({
                        height: "" + (f + 203) + "px"
                    }, 400), e.addClass("leaving leaving-" + a.dir), setTimeout(function() {
                        return d.removeClass("coming-" + a.dir)
                    }, 300), l(".post-" + a.post.ID + " .gallery"), setTimeout(function() {
                        e.remove(), d.removeClass("coming"), c.postLoading = !1
                    }, 400)
                }, 50)
            }, k = function(a) {
                var c;
                return c = 0, b(a).each(function(a, d) {
                    var e;
                    return b(d).css("height", "auto"), e = b(d).height(), e > c ? c = e : void 0
                }), b(a).height(c)
            }, l = function(a, d, e, f) {
                return null == d && (d = 500), null == e && (e = 3e3), null == f && (f = !1), b(a).length > 0 ? b(a).each(function(h, i) {
                    var j, k;
                    if (k = b(i).data("images"), b(i).backstretch(k, {
                            fade: d,
                            duration: e
                        }), k.length > 1 && (f && b(i).backstretch("pause"), j = b(i).closest("[class$=wrapper]").siblings("" + a + "-nav"), 0 === j.length && (j = b(i).find("" + a + "-nav")), 0 !== j.length)) {
                        if (c.gallery = {}, c.gallery.$nav = j, c.gallery.e = i, c.gallery.selector = a, j.is("ol") ? (j.append("<li><a class='active' href='#'></a></li>" + "<li><a href='#'></a></li>".repeat(k.length - 1)).removeClass("hidden").find("li").each(function(a, c) {
                                b(c).css("transition-delay", 200 * a + "ms")
                            }), setTimeout(function() {
                                j.find("li").addClass("loaded")
                            }, 500)) : j.append("<a href='#' data-dir='prev'><i class='icon-angle-left'></i></a><span>1</span>/<span>" + k.length + "</span><a href='#' data-dir='next'><i class='icon-angle-right'></i></a>").removeClass("hidden"), b(c).off("backstretch.before", g), b(c).on("backstretch.before", g), j.is("ol")) return j.find("li a").click(function(a) {
                            var c;
                            return a.preventDefault(), c = j.find("li").index(b(this).closest("li")), b(i).backstretch("show", c)
                        });
                        j.is("div") && j.find("a").click(function(a) {
                            var c;
                            return a.preventDefault(), c = b(this).data("dir"), b(i).backstretch(c)
                        })
                    }
                }) : void 0
            }, g = function(a, d, e) {
                var f, g, h;
                f = c.gallery.$nav, g = c.gallery.e, h = c.gallery.selector, f.find("li a").removeClass("active").closest("li").filter(":eq(" + e + ")").find("a").addClass("active"), f.is("div") && (f.find("span").first().text(e + 1), b(".product-gallery-content").addClass("hidden"), b("#product-gallery-content-" + e).removeClass("hidden")), b(g).siblings("" + h + "-caption").length > 0 && (b("" + h + "-caption h3").addClass("leaving"), b("" + h + "-caption figure").css("background-color", ss_slides[e].bg_color), b("" + h + "-caption").attr("href", ss_slides[e].link), Modernizr.svg && PSRL.pathOuter.animate({
                    fill: ss_slides[e].bg_color
                }, 500, j), setTimeout(function() {
                    b(g).siblings("" + h + "-caption").find("h3").text(ss_slides[e].title).removeClass("leaving")
                }, 250))
            }, m = function() {
                var d, e;
                return b(c).on("load resize", function() {
                    return k(".store")
                }), d = new google.maps.LatLng(37.9908372, 23.7383394), 0 !== b("#store-map").length && (e = function() {
                    ...
                    if (g = {
                        ...
                        }, f = new google.maps.Map(document.getElementById("store-map"), g), c = new google.maps.LatLngBounds, i = b("#store-map").data("stores"), i.length > 0) {
                        for (j = [], k = function(a, d) {
                                return j[d] = {}, j[d].loc = new google.maps.LatLng(a.lat, a["long"]), j[d].marker = new google.maps.Marker({
                                    position: j[d].loc,
                                    map: f,
                                    title: a.title,
                                    icon: "" + PSRL.assetsDir + "img/map-pin.png"
                                }), j[d].infowindow = new google.maps.InfoWindow({
                                    content: b(".store-fm:eq(" + d + ")").clone().removeClass("hidden")[0],
                                    maxWidth: 300
                                }), google.maps.event.addListener(j[d].marker, "click", function() {
                                    return f.setZoom(17), f.setCenter(j[d].marker.getPosition()), j[d].infowindow.open(f, j[d].marker), b(".show-all-stores").removeClass("invisible")
                                }), c.extend(j[d].loc)
                            }, e = l = 0, m = i.length; m > l; e = ++l) h = i[e], k(h, e);
                        f.fitBounds(c), PSRL.map = f, PSRL.stores = j, PSRL.bounds = c
                    }
                }, google.maps.event.addDomListener(c, "load", e)), b("#stores h3 a").click(function(a) {
                    var d;
                    return a.preventDefault(), c.winWidth < 768 ? void 0 : (d = b(this), b("html, body").animate({
                        scrollTop: "" + (b("#store-map").offset().top - 60) + "px"
                    }, 500, function() {
                        var a;
                        a = b("#stores .store").index(d.closest(".store")), PSRL.map.setZoom(17), PSRL.map.setCenter(PSRL.stores[a].marker.getPosition()), PSRL.stores[a].infowindow.open(PSRL.map, PSRL.stores[a].marker), b(".show-all-stores").removeClass("invisible")
                    }))
                }), b(".show-all-stores").click(function(a) {
                    var c, d, e, f, g, h;
                    for (a.preventDefault(), PSRL.map.fitBounds(PSRL.bounds), b(".show-all-stores").addClass("invisible"), g = PSRL.stores, h = [], c = e = 0, f = g.length; f > e; c = ++e) d = g[c], h.push(function(a) {
                        return a.infowindow.close()
                    }(d, c));
                    return h
                })
            }
        }(jQuery, window), String.prototype.repeat = function(a) {
