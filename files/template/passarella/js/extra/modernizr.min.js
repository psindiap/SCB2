 ...
 * Build: http://modernizr.com/download/#-load-cssclasses-svg-history-opacity-backgroundsize-csstransforms
 */
;
window.Modernizr = function(e, t, n) {
        ...
        !k(x, "undefined") && !k(x.call, "undefined") ? T = function(e, t) {
            ...
            return C("opacity:.55"), /^0.55$/.test(f.opacity)
        }, g.csstransforms = function() {
            return !!M("transform")
        }, g.svg = function() {
            return !!t.createElementNS && !!t.createElementNS(m.svg, "svg").createSVGRect
        };
        for (var _ in g) T(g, _) && (S = _.toLowerCase(), i[S] = g[_](), w.push((i[S] ? "" : "no-") + S));
        return i.addTest = function(e, t) {
            ...
            return i
        }, N(""), a = l = null, i._version = r, i._prefixes = h, i._domPrefixes = v, i._cssomPrefixes = d, i.testProp = function(e) {
            return A([e])
        }, i.testAllProps = M, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + w.join(" ") : ""), i
    }(this, this.document),
    function(e, t, n) {
        function r(e) {
